...
type GetTaskByOrderRequest struct {
...
func (x *GetTaskByOrderRequest) Reset() {
	*x = GetTaskByOrderRequest{}
...
func (x *GetTaskByOrderRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTaskByOrderRequest) ProtoMessage() {}

func (x *GetTaskByOrderRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_task_proto_msgTypes[0]
...
// Deprecated: Use GetTaskByOrderRequest.ProtoReflect.Descriptor instead.
func (*GetTaskByOrderRequest) Descriptor() ([]byte, []int) {
	return file_proto_task_proto_rawDescGZIP(), []int{0}
}

func (x *GetTaskByOrderRequest) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
type Task struct {
	...
	NextRetryAt int64  `protobuf:"varint,7,opt,name=next_retry_at,json=nextRetryAt,proto3" json:"next_retry_at,omitempty"`
}
...
func (x *Task) GetNextRetryAt() int64 {
	if x != nil {
...
var file_proto_task_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x70, 0x62, 0x22, 0x32, 0x0a, 0x15, 0x47, 0x65,
	0x74, 0x54, 0x61, 0x73, 0x6b, 0x42, 0x79, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0xc2,
	...
	0x52, 0x05, 0x62, 0x69, 0x7a, 0x4e, 0x6f, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72,
	...
	,
...
var file_proto_task_proto_goTypes = []any{
	(*GetTaskByOrderRequest)(nil), // 0: taskpb.GetTaskByOrderRequest
	(*Task)(nil),                  // 1: taskpb.Task
}
var file_proto_task_proto_depIdxs = []int32{
	0, // 0: taskpb.TaskService.GetTaskByOrder:input_type -> taskpb.GetTaskByOrderRequest
	1, // 1: taskpb.TaskService.GetTaskByOrder:output_type -> taskpb.Task
...
func file_proto_task_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_task_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*GetTaskByOrderRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
